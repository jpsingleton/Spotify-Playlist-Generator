    ...
    internal class Request
    {
        ...
        public XmlDocument execute()
        {
            ...
            */
            ...
            // *** JS Bug Fix - as above but needs to be set on each request otherwise this is sometimes still added.
            //                  Would be better still to use the GET method instead of POST for caching proxies etc.
